...
<div class="container">
    ...
    <c:url var="saveUrl" value="/transport/edit?id=${transportAttribute.id}" />
<form:form modelAttribute="transportAttribute" method="POST" action="${saveUrl}" enctype="multipart/form-data">
    <div class="container mt-3 mb-4 text-center" > <h2><spring:message code="transport"/></h2> </div>
    ...
    <div class="form-group row">
        <form:label path="name" class="col-sm-2 col-form-label"><spring:message code="description"/></form:label>
        <div class="col-sm-7">
